...
class TestUpdateTodo:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (1,{'title':'New title','description':'New description','completed':True,'user_id':1},200,{"message": "Todo updated successfully!"}),
            (1, {'title': 1, 'description': 'New description', 'completed': True, 'user_id': 1}, 422,{'error': 'Validation error', 'details': [{'field': 'title', 'message': 'Input should be a valid string'}]}),
            (1, {'title': 'New Title', 'description': 'New description', 'completed': True, 'user_id': 1000}, 400,{'detail': 'Invalid user'}),
            (99, {'title': 'New Title', 'description': 'New description', 'completed': True, 'user_id': 1000}, 404,{'detail': 'Todo not found'})
...
class TestUpdateTodos:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ([1,],True,200,{'message':'Todos successfully updated'}),
