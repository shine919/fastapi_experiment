...
class TestUserPut:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                1,
                {"id": 1, "username": "testuser", "password": "123", "email": "test@example.com", "role": "user"},
                200,
            ...
            (
                1,
                {"id": 1, "username": 1, "password": "123", "email": "test@example.com", "role": "user"},
                422,
                {
                    "error": "Validation error",
                    "details": {"field": "username", "message": "Input should be a valid string"},
                },
            ),
        ],
    )
...
class TestUserPatch:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (1, "password", {"password": "123"}, 200, {"password": crypt_context.hash("123")}),
            (
                4,
                None,
                {"id": 1, "username": "testuser", "password": "123", "email": "test@example.com", "role": "user"},
